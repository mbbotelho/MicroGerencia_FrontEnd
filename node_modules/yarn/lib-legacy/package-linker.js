    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      if (_this2.config.binLinks) {
        ...
        yield (_promise2 || _load_promise2()).queue(linksToCreate, (() => {
          var _ref11 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (_ref10) {
            var _ref12 = (0, (_slicedToArray2 || _load_slicedToArray()).default)(_ref10, 2);
